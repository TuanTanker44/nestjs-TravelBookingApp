...
const DESTINATIONS = [
  ...
  },
  {
    name: "Hội An",
    count: "64 khách sạn",
    img: "https://images.unsplash.com/photo-1540317580384-e5d43616b9aa?w=600&q=80",
  },
  {
    name: "Phú Quốc",
    count: "102 khách sạn",
...
export default function HomePage() {
  ...
  useEffect(() => {
    hotelApi
      .get("/hotel", { params: { page: 1, limit: 6 } })
      .then((res) => {
  ...
  return (
    <div className="min-h-screen" style={{ background: "var(--bg)" }}>
      ...
      <section className="relative flex min-h-screen items-center justify-center overflow-hidden px-6 text-center">
        <img
          src="https://images.unsplash.com/photo-1540202404-a2f29016b523?w=1800&q=80"
          alt=""
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(to bottom, rgba(10,10,15,0.55) 0%, rgba(10,10,15,0.75) 60%, rgba(10,10,15,1) 100%)",
          }}
        />

        <div className="relative z-10 max-w-4xl w-full">
          <p className="mb-4 text-xs font-bold uppercase tracking-[0.3em] text-gold">
            ✦ Khám phá · Trải nghiệm · Thư giãn
          </p>
          <h1
            className="font-display mb-6 font-bold"
            style={{
          ...
          >
            Khám phá hơn 1,200 khách sạn và resort cao cấp trên toàn Việt Nam —
      ...
      <section className="mx-auto max-w-7xl px-6 py-20">
        <div className="mx-auto mb-10 max-w-3xl text-center">
          <div>
            <p className="mb-1 text-xs font-bold uppercase tracking-[0.2em] text-gold">
              Nổi bật
            </p>
            <h2
          ...
          <button
            ...
            className="mt-6 hidden rounded-xl px-6 py-3 text-sm font-semibold transition hover:border-gold md:inline-flex"
            style={{
        ...
        <div className="mt-8 text-center md:hidden">
          <button
            onClick={() => router.push("/search")}
            className="btn-gold rounded-xl px-8 py-3.5 text-sm font-bold"
          >
          ...
          <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
            {DESTINATIONS.map((d) => (
              <button
                key={d.name}
                onClick={() =>
                  router.push(`/search?keyword=${encodeURIComponent(d.name)}`)
                }
              ...
              >
                ...
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(to top, rgba(10,10,15,0.85) 0%, rgba(10,10,15,0.1) 60%)",
                  }}
                />
      ...
      <section className="px-6 py-24">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h2
            className="font-display mb-5 text-5xl font-bold"
          ...
          <button
            onClick={() => router.push("/search")}
            className="btn-gold rounded-2xl px-10 py-4 text-base font-bold"
          >
            Tìm khách sạn ngay →
          </button>
        </div>
      ...
      >
        <div className="mx-auto max-w-7xl px-6 py-12 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <p className="text-xs" style={{ color: "var(--muted)" }}>
            © 2025 TravelBook. Đặt phòng khách sạn cao cấp toàn Việt Nam.
          </p>
